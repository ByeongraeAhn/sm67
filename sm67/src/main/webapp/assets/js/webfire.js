...
! function(t) {
    ...
    s.prototype.options = {
    	...
    	//slide 이동
        $(this.slides[this.current || 0]).removeClass("current"), this.current = this.dd.getStep()[0] - 1, $(this.slides[this.current]).addClass("current"), $("body")[0].className = $("body")[0].className.replace(/\bviewing-page-\d.*?\b/g, ""), $("body").addClass("viewing-page-" + this.current), console.log(this.current), speechTextKorean(this.current+" 번째 페이지이동");
        var t = this.dd.getStep()[0] - 1,
            e = null,
            s = "0%";
        0 === t ? (s = "0%", history.pushState(null, "App Agency London | webfire specialise in Web Apps, Mobile Apps, Tablet Apps, Web Design & CMS", "")
        		) : 1 === t ? (s = "10%", history.pushState(null, "App Agency London | Our History", "")) : 2 === t ? (s = "20%", history.pushState(null, "App Agency London | Our Growth", "")) : 3 === t ? (s = "30%", history.pushState(null, "App Agency London | Our Work, Touchscreen Apps, iOS, Android, HTML5", "")) : 4 === t ? (s = "40%", history.pushState(null, "App Agency London | Cognizant Code Halos, iPad App", "")) : 5 === t ? (s = "50%", history.pushState(null, "App Agency London | Space Exploration Network, Touchscreen Website + Mobile Site", "")) : 6 === t ? (s = "60%", history.pushState(null, "App Agency London | Preoday, Web App + Mobile App", "")) : 7 === t ? (e = "7", s = "70%", history.pushState(null, "App Agency London | Endeavr, Aggregator App", "")) : 8 === t ? (e = "8", s = "80%", history.pushState(null, "App Agency London | Time For Bed, Mobile App", "")) : 9 === t ? (e = "9", s = "90%", history.pushState(null, "App Agency London | The Future", "")) : 10 === t && (s = "100%", history.pushState(null, "App Agency London | Contact Us", "")), $(".stage").stop().animate({
            width: s
        })
