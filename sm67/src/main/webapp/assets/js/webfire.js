...
! function(t) {
    ...
    s.prototype.options = {
        ...
        var t = this.dd.getStep()[0] - 1,
            e = null,
            s = "0%";
        0 === t ? (s = "0%", history.pushState(null, "App Agency London | webfire specialise in Web Apps, Mobile Apps, Tablet Apps, Web Design & CMS", ""),speechTextKorean("")
        		) : 1 === t ? (s = "10%", history.pushState(null, "App Agency London | Our History", ""),speechTextKorean($('#bio_msg').text())) : 2 === t ? (s = "20%", history.pushState(null, "App Agency London | Our Growth", ""), speechTextKorean($('#weather_msg').text()) ) : 3 === t ? (s = "30%", history.pushState(null, "App Agency London | Our Work, Touchscreen Apps, iOS, Android, HTML5", ""),speechTextKorean("")) : 4 === t ? (s = "40%", history.pushState(null, "App Agency London | Cognizant Code Halos, iPad App", "")) : 5 === t ? (s = "50%", history.pushState(null, "App Agency London | Space Exploration Network, Touchscreen Website + Mobile Site", ""),speechTextKorean($('#traffic_msg').text())) : 6 === t ? (s = "60%", history.pushState(null, "App Agency London | Preoday, Web App + Mobile App", "")) : 7 === t ? (e = "7", s = "70%", history.pushState(null, "App Agency London | Endeavr, Aggregator App", "")) : 8 === t ? (e = "8", s = "80%", history.pushState(null, "App Agency London | Time For Bed, Mobile App", "")) : 9 === t ? (e = "9", s = "90%", history.pushState(null, "App Agency London | The Future", "")) : 10 === t && (s = "100%", history.pushState(null, "App Agency London | Contact Us", "")), $(".stage").stop().animate({
            width: s
        })
